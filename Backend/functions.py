...
def XMLSystemConfigurationCustomers(xml):
    doc = parseString(xml)
    datos = []
    numero_clientes = 0
    numero_instancias = 0
    ...
    for cliente in clientes:
        ...
        for instancia in listas_instancias_cliente:
            ...
            fecha_inicio.appendChild(bd.createTextNode(fecha_inicio_instancia))
            ...
            if estado_instancia.strip() == "Cancelada":
                ...
                fecha_fin.appendChild(bd.createTextNode(fecha_fin_instancia))
