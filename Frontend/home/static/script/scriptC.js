...
function enviarContenido(contenido) {
    ...
    fetch('http://127.0.0.1:3000/configuracion', {
        method: 'POST',
        body: contenido,
        headers: {
        ...
        */
        .then(response => {
            ...
            let instancias = response.Instancias
            swal("¡Correcto!", "Se han agregado " + clientes + " clientes y " + instancias + " intancias", "success");
        })
}
